...
setup(name='dace',
      ...
      install_requires=[
          ...
          'fparser >= 0.1.3', 'aenum >= 3.1', 'dataclasses', 'dill',
          'pyreadline;platform_system=="Windows"', 'typing-compat; python_version < "3.8"', 'packaging',
          'onnx', 'torch', 'onnxsim', 'protobuf',
      ] + cmake_requires,
      extras_require={
          'testing': ['coverage', 'pytest-cov', 'scipy', 'absl-py', 'opt_einsum', 'pymlir', 'click', 'transformers'],
          'docs': ['jinja2<3.2.0', 'sphinx-autodoc-typehints', 'sphinx-rtd-theme>=0.5.1', 'matplotlib']
      },
      entry_points={
          'console_scripts': [
