...
#
    ...
    def Run(self, fail_on_nonzero=None, run_sync=True):
        ...
        if run_sync:
            executor = Executor(self.perfplot, self.headless,
                                self.rendered_sdfgs, None)
    ...
    def OnReadSystemInfo(self, *args):
        from dace.codegen.instrumentation.perfsettings import PAPIInstrumentation, PerfPAPIInfoStatic
