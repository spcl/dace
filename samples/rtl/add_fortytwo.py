    ...
    */
    ...
    always@(posedge ap_aclk) begin
        if (ap_areset) begin // case: reset
            ...
            s_axis_a_tready <= !m_axis_b_tvalid;
            state <= DONE;
        end
    end
    ''',
...
copy_to_device.add_memlet_path(cpu_a, dev_a, memlet=dace.Memlet.simple('A', '0:N'))
...
copy_to_host.add_memlet_path(dev_b, cpu_b, memlet=dace.Memlet.simple('B', '0:N'))
