...
static inline double iqr_frac(const Stat& s) { return (s.p75 - s.p25) / s.median; }
...
static inline bool bitsame(const void* a, const void* b, size_t n) { return std::memcmp(a, b, n) == 0; }
