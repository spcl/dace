...
if __name__ == '__main__':
    ...
    sdfg_path = Path(os.environ["HOME"]) / "projects/tuning-dace/hG-prepared-256.sdfg"
    ...
    big_sdfg.save(Path(os.environ["HOME"]) / "projects/tuning-dace/hG-256-otf-transfer.sdfg")
    ...
    sdfg_path = Path(os.environ["HOME"]) / "projects/tuning-dace/hG-256-SGF-transfer.sdfg"
