...
if __name__ == '__main__':
    ...
    sdfg_path = Path(os.environ["HOME"]) / "projects/tuning-dace/hG-prepared-192.sdfg"
    ...
    big_sdfg.save(Path(os.environ["HOME"]) / "projects/tuning-dace/hG-192-otf-transfer.sdfg")
    ...
    sdfg_path = Path(os.environ["HOME"]) / "projects/tuning-dace/hG-192-SGF-transfer.sdfg"
