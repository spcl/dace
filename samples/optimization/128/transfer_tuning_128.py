...
if __name__ == '__main__':
    ...
    sdfg_path = Path(os.environ["HOME"]) / "projects/tuning-dace/hg-fvt-128.sdfg"
    ...
    sdfg_path = Path(os.environ["HOME"]) / "projects/tuning-dace/hG-prepared-128.sdfg"
    ...
    big_sdfg.save(Path(os.environ["HOME"]) / "projects/tuning-dace/hG-128-otf-transfer.sdfg")
    ...
    sdfg_path = Path(os.environ["HOME"]) / "projects/tuning-dace/hG-128-SGF-transfer.sdfg"
