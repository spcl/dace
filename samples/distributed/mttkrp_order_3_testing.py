...
if __name__ == "__main__":
    ...
    if rank == 0:
        sdfg1 = mttkrp_order_3_mode_0.to_sdfg(simplify=True)
        sdfg1c = mttkrp_order_3_mode_0_compute.to_sdfg(simplify=True)
        sdfg2 = mttkrp_order_3_mode_1.to_sdfg(simplify=True)
        sdfg2c = mttkrp_order_3_mode_1_compute.to_sdfg(simplify=True)
        sdfg3 = mttkrp_order_3_mode_2.to_sdfg(simplify=True)
        sdfg3c = mttkrp_order_3_mode_2_compute.to_sdfg(simplify=True)
    ...
    if rank == 0:
        ...
        write_time(str(datetime.now()), "mttkrp_order_3_mode_0", "dace_cpu", size, (S, S, S, R), runtimes, file_name, field_names, append=True)
    ...
    if rank == 0:
        print(f"Median total runtime: {np.median(runtimes)} seconds", flush=True)
        write_time(str(datetime.now()), "mttkrp_order_3_mode_1", "dace_cpu", size, (S, S, S, R), runtimes, file_name, field_names, append=True)
        ...
        print(f"Median compute runtime: {np.median(runtimes)} seconds")
        write_time(str(datetime.now()),"mttkrp_order_3_mode_1_compute", "dace_cpu", size, (S, S, S, R), runtimes, file_name, field_names, append=True)
    ...
    if rank == 0:
        print(f"Median total runtime: {np.median(runtimes)} seconds", flush=True)
        write_time(str(datetime.now()), "mttkrp_order_3_mode_2", "dace_cpu", size, (S, S, S, R), runtimes, file_name, field_names, append=True)
        ...
        print(f"Median compute runtime: {np.median(runtimes)} seconds")
        write_time(str(datetime.now()),"mttkrp_order_3_mode_2_compute", "dace_cpu", size, (S, S, S, R), runtimes, file_name, field_names, append=True)
