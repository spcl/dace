...
if __name__ == "__main__":
    ...
    lX = cupy.asarray(rng.random((SG[0], SG[1], SG[2], SG[3], SG[4])))
    lI = cupy.asarray(rng.random((SG[0], SG[5])))
    lJ = cupy.asarray(rng.random((SG[1], SG[5])))
    lK = cupy.asarray(rng.random((SG[2], SG[5])))
    lL = cupy.asarray(rng.random((SG[3], SG[5])))
    lM = cupy.asarray(rng.random((SG[4], SG[5])))
    ...
    if rank == 0:
        ...
        write_time(str(datetime.now()), "mttkrp_order_5_mode_0", "dace_gpu_cupy", size, (S, S, S, S, S, R), runtimes, file_name, field_names, append=True)
        ...
        write_time(str(datetime.now()),"mttkrp_order_5_mode_0_compute", "dace_gpu_cupy", size, (S, S, S, S, S, R), runtimes, file_name, field_names, append=True)
    
    # MTTKRP, order 3, mode 2

    val = cupy.ndarray((SG[2], SG[5]), dtype=nptype)
    ...
    if rank == 0:
        print(f"Median total runtime: {np.median(runtimes)} seconds", flush=True)
        write_time(str(datetime.now()), "mttkrp_order_5_mode_2", "dace_gpu_cupy", size, (S, S, S, S, S, R), runtimes, file_name, field_names, append=True)
        ...
        print(f"Median compute runtime: {np.median(runtimes)} seconds")
        write_time(str(datetime.now()),"mttkrp_order_5_mode_2_compute", "dace_gpu_cupy", size, (S, S, S, S, S, R), runtimes, file_name, field_names, append=True)

    # MTTKRP, order 5, mode 4

    val = cupy.ndarray((SG[4], SG[5]), dtype=nptype)
    ...
    if rank == 0:
        print(f"Median total runtime: {np.median(runtimes)} seconds", flush=True)
        write_time(str(datetime.now()), "mttkrp_order_5_mode_4", "dace_gpu_cupy", size, (S, S, S, S, S, R), runtimes, file_name, field_names, append=True)
        ...
        print(f"Median compute runtime: {np.median(runtimes)} seconds")
        write_time(str(datetime.now()),"mttkrp_order_5_mode_4_compute", "dace_gpu_cupy", size, (S, S, S, S, S, R), runtimes, file_name, field_names, append=True)
