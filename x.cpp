...
inline void fuse_branches_test_pattern_from_cloudsc_one_1526_4_1527_8_0_0_9(
    ...
    const double& __tmp_1528_21_r, const double& __tmp_1528_34_r,
    const double& __tmp_1529_34_r, double& __tmp_1528_12_w,
    double& __tmp_1531_16_w, double& __tmp_1532_16_w) {
  bool _if_cond_5;
  {
    double B_slice;
    {
  ...
  for (int i = 0; i < 32; i++) {
    for (int j = 0; j < 32; j++) {
      fuse_branches_test_pattern_from_cloudsc_one_1526_4_1527_8_0_0_9(
          __state, A[((32 * i) + j) + 1024], A[(32 * i) + j], c,
          B[(32 * i) + j], D[(32 * i) + j], E[(32 * i) + j]);
    }
  }
}
...
int main() {
  ...
  double c = dist(rng);
  __program_fuse_branches_test_pattern_from_cloudsc_one_internal(
      &s1, A.data(), B1.data(), D1.data(), E1.data(), c);
  __program_fuse_branches_test_pattern_from_cloudsc_one_transformed_internal(
      &s2, A.data(), B2.data(), D2.data(), E2.data(), c);
