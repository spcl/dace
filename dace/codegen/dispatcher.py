...
class TargetDispatcher(object):
    ...
    def dispatch_subgraph(self,
                          sdfg: SDFG,
                          dfg: Union[SDFGState, StateSubgraphView],
                          state_id: int,
        ...
        """ Dispatches a code generator for a subgraph of an ``SDFGState``. """

        start_nodes = list(v for v in dfg.nodes() if len(list(dfg.predecessors(v))) == 0)
        nodes_to_skip = set()  # Scope nodes that will be generated by dispatch_scope can be skipped
