...
class CPUCodeGen(TargetCodeGenerator):
    ...
    def deallocate_array(self, sdfg: SDFG, cfg: ControlFlowRegion, dfg: StateSubgraphView, state_id: int,
        ...
        operator = 'delete[]'
        if isinstance(nodedesc, data.Scalar) and not isinstance(nodedesc, data.StructureView):
            operator = 'delete'
    ...
    def generate_nsdfg_header(self, sdfg, cfg, state, state_id, node, memlet_references, sdfg_label, state_struct=True, gpu=False):
