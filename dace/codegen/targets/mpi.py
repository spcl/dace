...
DACE_EXPORTED int __dace_init_mpi_{sdfg_name}({sdfg_state_name} *__state{params});
DACE_EXPORTED int __dace_exit_mpi_{sdfg_name}({sdfg_state_name} *__state);

int __dace_init_mpi_{sdfg_name}({sdfg_state_name} *__state{params}) {{
    int isinit = 0;
...
int __dace_exit_mpi_{sdfg_name}({sdfg_state_name} *__state) {{
