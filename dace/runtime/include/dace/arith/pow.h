...
static inline double dace_pow_d(double x, double y) { return dace_exp_d(y * dace_log_d(x)); }

static inline float dace_pow_f(float x, float y) { return dace_exp_f(y * dace_log_f(x)); }
