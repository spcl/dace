...
template <>
struct is_scalar<__nv_fp8_e4m3> : std::integral_constant<bool, true> {};
template <>
struct is_fundamental<__nv_fp8_e4m3> : std::integral_constant<bool, true> {};
template <>
struct is_scalar<__nv_fp8_e5m2> : std::integral_constant<bool, true> {};
template <>
struct is_fundamental<__nv_fp8_e5m2> : std::integral_constant<bool, true> {};
    }  // namespace std
...
struct is_fundamental<half> : std::integral_constant<bool, true> {};
template <>
struct is_scalar<__hip_bfloat16> : std::integral_constant<bool, true> {};
template <>
struct is_fundamental<__hip_bfloat16> : std::integral_constant<bool, true> {};
template <>
struct is_scalar<__hip_fp8_e4m3> : std::integral_constant<bool, true> {};
template <>
struct is_fundamental<__hip_fp8_e4m3> : std::integral_constant<bool, true> {};
template <>
struct is_scalar<__hip_fp8_e5m2> : std::integral_constant<bool, true> {};
template <>
struct is_fundamental<__hip_fp8_e5m2> : std::integral_constant<bool, true> {};
    }  // namespace std
#endif
...
#if !defined(DACE_HALF_NO_NATIVE) && (defined(DACE_HALF_FORCE_NATIVE) ||                                  \
...
DACE_LP_LIMITS(float8_e5m2, 3, 0, 1, -13, -4, 16, 4, false, true, 5.7344e+4f, 6.103515625e-05f, 2.5e-01f,
               1.52587890625e-05f);
DACE_LP_LIMITS(float8_e4m3fn, 4, 0, 2, -5, -2, 9, 2, false, false, 4.48e+2f, 1.5625e-02f, 1.25e-01f, 1.953125e-03f);
}
...
static_assert(std::bit_cast<uint8_t>(std::numeric_limits<dace::float8_e5m2>::max()) == 0x7B &&
                  std::bit_cast<uint8_t>(std::numeric_limits<dace::float8_e5m2>::denorm_min()) == 0x01,
              "e5m2 limits");
static_assert(std::bit_cast<uint8_t>(std::numeric_limits<dace::float8_e4m3fn>::max()) == 0x7E &&
                  std::bit_cast<uint8_t>(std::numeric_limits<dace::float8_e4m3fn>::denorm_min()) == 0x01,
              "e4m3fn limits");
#endif
