...
struct typeless_nan {
  ...
  DACE_CONSTEXPR DACE_HDFI typeless_nan& operator=(
      const typeless_nan&) noexcept = default;
  DACE_CONSTEXPR DACE_HDFI typeless_nan& operator=(typeless_nan&&) noexcept =
      default;
...
template <typename T>
DACE_CONSTEXPR DACE_HDFI std::enable_if_t<std::is_floating_point<T>::value ||
...
DACE_CONSTEXPR DACE_HDFI typeless_nan operator*(const typeless_nan&,
                                                const typeless_nan&) noexcept {
  return typeless_nan{};
}
...
#define FADAPT(F)                                                         \
  DACE_CONSTEXPR DACE_HDFI typeless_nan F(const typeless_nan&) noexcept { \
    return typeless_nan{};                                                \
  }
#define FADAPT2(F)                                                             \
  template <typename T1>                                                       \
  DACE_CONSTEXPR DACE_HDFI typeless_nan F(T1&&,                                \
                                          dace::math::typeless_nan) noexcept { \
    return typeless_nan{};                                                     \
  };                                                                           \
  template <typename T2>                                                       \
  DACE_CONSTEXPR DACE_HDFI typeless_nan F(const typeless_nan&,                 \
                                          T2&&) noexcept {                     \
    return typeless_nan{};                                                     \
  };                                                                           \
  DACE_CONSTEXPR DACE_HDFI typeless_nan F(const typeless_nan&,                 \
