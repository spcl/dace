...
def deconstruct_interface_calls(ast: Program) -> Program:
    ...
    for fref in walk(ast, (Function_Reference, Call_Stmt)):
        ...
        for cand in iface_map[ifc_spec]:
            ...
            if _match(args_sig, cand_args_sig):
                conc_spec = cand_spec
                break
