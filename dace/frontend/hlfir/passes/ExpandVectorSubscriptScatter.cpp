// ============================================================================
// ExpandVectorSubscriptScatter.cpp  --  replace hlfir.region_assign with
// elemental_addr destination (Fortran array-based scatter) by an explicit DO
// loop.
// ============================================================================
//
...
//     ExpandVectorSubscriptGather.cpp's header for the full DaCe-side
//     rationale.
// ============================================================================
...
struct ExpandVectorSubscriptScatterPass
 ...
 private:
  mlir::LogicalResult rewrite(hlfir::RegionAssignOp op) {
    ...
    if (!destAddr) {
      return op.emitError(
          "hlfir-expand-vector-subscript-scatter: could not capture "
          "destination "
