...
CREATION_CALLS = frozenset({
    ...
    'numpy.empty_like', 'numpy.copy', 'numpy.arange', 'dace.define_stream', 'dace.define_streamarray', 'numpy.ndarray',
    'dace.ndarray', 'dace.define_local', 'dace.define_local_scalar'
})
...
def lower_creation(qualname: str, target: DataAccess, call: ast.Call, statement: ast.stmt,
    ...
    if function in ('empty', 'empty_like', 'define_stream', 'define_streamarray', 'ndarray', 'define_local',
                    'define_local_scalar'):
