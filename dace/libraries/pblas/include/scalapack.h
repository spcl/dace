...
void psgemv_(char *trans, int *m, int *n, float *alpha, float *a, int *ia,
             int *ja, int *desca, float *x, int *ix, int *jx, int *descx,
             int *incx, float *beta, float *y, int *iy, int *jy, int *descy,
             int *incy);
void pdgemv_(char *trans, int *m, int *n, double *alpha, double *a, int *ia,
             int *ja, int *desca, double *x, int *ix, int *jx, int *descx,
             int *incx, double *beta, double *y, int *iy, int *jy, int *descy,
             int *incy);
void pcgemv_(char *trans, int *m, int *n, complex_s *alpha, complex_s *a,
             int *ia, int *ja, int *desca, complex_s *x, int *ix, int *jx,
             int *descx, int *incx, complex_s *beta, complex_s *y, int *iy,
             int *jy, int *descy, int *incy);
void pzgemv_(char *trans, int *m, int *n, complex_d *alpha, complex_d *a,
             int *ia, int *ja, int *desca, complex_d *x, int *ix, int *jx,
             int *descx, int *incx, complex_d *beta, complex_d *y, int *iy,
             int *jy, int *descy, int *incy);

void psgemm_(char *transa, char *transb, int *m, int *n, int *k, float *alpha,
...
void pcgemm_(char *transa, char *transb, int *m, int *n, int *k,
             ...
             complex_s *b, int *ib, int *jb, int *descb, complex_s *beta,
             complex_s *c, int *ic, int *jc, int *descc);
void pzgemm_(char *transa, char *transb, int *m, int *n, int *k,
             complex_d *alpha, complex_d *a, int *ia, int *ja, int *desca,
             complex_d *b, int *ib, int *jb, int *descb, complex_d *beta,
