...
#include <cmath>
  ...
  #define _dace_vectorize _Pragma("clang loop vectorize(enable) vectorize_width({vector_width}8)")
#elif defined(__GNUC__)
  #define _dace_vectorize _Pragma("GCC ivdep") _Pragma("omp simd simdlen({vector_width})")
#else
