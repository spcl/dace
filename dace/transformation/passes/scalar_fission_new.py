...
class ScalarFission(ppl.Pass):
    ...
    def depends_on(self):
        return {ap.AccessSets, ap.SymbolAccessSets, ap.FindAccessNodes, ap.StateReachability}
    ...
    def apply_pass(self, sdfg: SDFG, pipeline_results: Dict[str, Any]) -> Optional[Dict[str, Set[str]]]:
        ...
        def find_reaching_def(state: SDFGState, var: str, node: nd.AccessNode = None):
            ...
            if state in phi_nodes.keys() and phi_nodes[state].get(var):
            ...
            while (defining_states):
                ...
                for frontier_state in dominance_frontier:
                    ...
                    if frontier_state in phi_states:
                        continue
                    if frontier_state not in phi_nodes.keys():
                        phi_nodes[frontier_state] = {}
        ...
        for current_state in dom_tree_dfs:
            ...
            for var in anames:
                ...
                if current_state not in phi_nodes.keys() or not phi_nodes[current_state].get(var):
                    continue
            ...
            for node in toposort:
                ...
                if (len(iedges) >0 and not renamed.get(var)):
            ...
            for successor in successors:
                for var in anames:
                    if successor not in phi_nodes.keys() or not phi_nodes[successor].get(var):
                        continue
            ...
            for original_var, phi_node in phi_dict.items():
                ...
                for other_state in candidate_states:
                    ...
                    if (not other_state is state and 
                        ...
                        if other_phi_node["name"] in parameters and is_read:
