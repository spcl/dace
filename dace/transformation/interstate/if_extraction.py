...
class IfExtraction(transformation.MultiStateTransformation):
    ...
    def apply(self, _, if_sdfg: sd.SDFG):
        ...
        IfExtraction._eliminate_branch(if_sdfg, if_sdfg.out_edges(if_root_state)[1].dst)
        ...
        IfExtraction._eliminate_branch(else_sdfg, else_sdfg.out_edges(else_root_state)[0].dst)
