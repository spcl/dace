...
# def analyze_sdfg_OLD(sdfg: SDFG, op_in_map: Dict[str, sp.Expr], analyze_tasklet, assumptions: [str],
...
def analyze_sdfg_op_in(sdfg: SDFG, op_in_map: Dict[str, sp.Expr], C, L, assumptions):
    ...
    for uuid in op_in_map:
        op_in_map[uuid] = str(round(int(work_map[uuid][0]) / op_in_map[uuid], 4) if op_in_map[uuid] != 0 else 0)
