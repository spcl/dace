...
the 65-kernel TSVC2.5 corpus. Standalone (only needs dace+numpy importable);
...
def main():
    ...
    sigs, compiled = ({}, {}) if args.save_sdfg_only else prepare_native_libs(
        args.results_dir, rank, nthreads=args.native_threads)
