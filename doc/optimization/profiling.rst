...
There is also the :class:`~dace.dtypes.InstrumentationType.GPU_TX_MARKERS` instrumentation type which wraps with NVTX markers the CUDA kernels launched from the top level SDFG.
