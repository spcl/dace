...
def make_receiver_sdfg():
    ...
    tasklet_wr, map_entry_wr, map_exit_wr = nested_axpy_2_state.add_mapped_tasklet(
        ...
        dict(
            inp_stream=dace.Memlet.simple(stream_read.data,
                                          'i'),  # input memlets
...
out = inp_stream + inp_mem
    ...
    nested_axpy_2_state.add_edge(stream_read,
                                 None,
                                 map_entry_wr,
                                 None,
                                 memlet=dace.Memlet.simple(
                                     stream_read.data, '0:N'))
    nested_axpy_2_state.add_edge(in_read_C,
                                 None,
                                 map_entry_wr,
                                 None,
                                 memlet=dace.Memlet.simple(
    ...
    nested_axpy_2_state.add_edge(map_exit_wr,
                                 None,
                                 stream_write,
                                 None,
                                 memlet=dace.Memlet.simple(
    ...
    nested_axpy_2_node = parent_nested_axpy.add_nested_sdfg(
        nested_axpy_2_sdfg, parent_sdfg, {"stream_in", "mem_C"}, {"stream_out"})
    ...
    _, stream_node_wr = parent_sdfg.add_stream(
        "stream_wr",
        dtype=dace.float32,
        transient=True,
        storage=dace.dtypes.StorageType.FPGA_Remote)
