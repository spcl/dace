...
#
#   tests/perf/run_cloudsc_codegen_ab.sh [base-ref] [new-ref] [reps] [outdir] [harness-ref]
#   tests/perf/run_cloudsc_codegen_ab.sh origin/main origin/rm-redundant-getattr-hasattr 5 /scratch/ab
#
...
# runnable: neither directory exists there. cloudsc additionally needs the corpus fix that keeps
# cloudsc.py from importing the transformation stack at module scope.
set -euo pipefail
