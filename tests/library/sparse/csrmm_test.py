...
@pytest.mark.parametrize("alpa", "beta", "implementation, dtype", [
...
if __name__ == "__main__":
    ...
    test_csrmm(2.0, 1.0, "MKL", dace.float32)
    test_csrmm(2.0, 1.0, "MKL", dace.float64)
    test_csrmm(1.0, 0.0, "cuSPARSE", dace.float32)
    test_csrmm(1.0, 0.0, "cuSPARSE", dace.float64)
    #test_csrmm(2.0, 1.0, "cuSPARSE", dace.float32)
    #test_csrmm(2.0, 1.0, "cuSPARSE", dace.float64)
