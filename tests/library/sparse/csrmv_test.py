...
def make_sdfg(alpha: float, beta: float, implementation: str, dtype) -> dace.SDFG:
    ...
    library_node = CSRMV("csrmv", alpha=alpha, beta=beta)
...
def test_csrmv(alpha, beta, implementation, dtype):
    ...
    sdfg(A_row=A_row, A_val=A_val, A_col=A_col, B=B, C=C, N=n, M=m, NNZ=nnz)
...
if __name__ == "__main__":
    # make_sdfg(1.0, 0.0, "cuSPARSE", dace.float32).view()
    test_csrmv(1.0, 0.0, "pure", dace.float64)
    test_csrmv(1.0, 1.0, "pure", dace.float32)
    test_csrmv(1.0, 1.0, "pure", dace.float64)
    test_csrmv(2.0, 2.0, "pure", dace.float32)
    test_csrmv(2.0, 2.0, "pure", dace.float64)
    test_csrmv(1.0, 0.0, "pure", dace.float32)
    test_csrmv(1.0, 0.0, "MKL", dace.float32)
    test_csrmv(1.0, 0.0, "MKL", dace.float64)
    test_csrmv(1.0, 1.0, "MKL", dace.float32)
    test_csrmv(1.0, 1.0, "MKL", dace.float64)
    test_csrmv(2.0, 2.0, "MKL", dace.float32)
    test_csrmv(2.0, 2.0, "MKL", dace.float64)
    test_csrmv(1.0, 0.0, "cuSPARSE", dace.float32)
    test_csrmv(1.0, 0.0, "cuSPARSE", dace.float64)
    test_csrmv(1.0, 1.0, "cuSPARSE", dace.float32)
