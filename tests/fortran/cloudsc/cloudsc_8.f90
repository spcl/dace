PROGRAM flux_diagnostics
    ...
    CALL flux_diagnostics_routine( &
        & KLON, KLEV, KIDIA, KFDIA, NCLV, NCLDQL, NCLDQI, NCLDQR, NCLDQS, &
        & RLVTT, RLSTT, &
        & PFPLSL, PFPLSN, PFHPSL, PFHPSN, ZPFPLSX, &
...
SUBROUTINE flux_diagnostics_routine( &
    & KLON, KLEV, KIDIA, KFDIA, NCLV, NCLDQL, NCLDQI, NCLDQR, NCLDQS, &
    & RLVTT, RLSTT, &
    & PFPLSL, PFPLSN, PFHPSL, PFHPSN, ZPFPLSX, &
    & PFSQLF, PFSQIF, PFCQNNG, PFCQLNG, PFSQRF, PFSQSF, PFCQRNG, PFCQSNG, PFSQLTUR, PFSQITUR, &
...
END SUBROUTINE flux_diagnostics_routine