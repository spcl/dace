...
module lib
  ...
  type T3
    ...
    ! Check whether large exponents are serialized correctly
    double precision :: e1 = 1d+128
    double precision :: e2 = 1d-128
  end type T3
...
1
# entries
0.50999999046325683594E+001
0.50999999046325683594E+001
0.50999999046325683594E+001
0.50999999046325683594E+001
# c
0.30000000000000000000E+001
# cc
# rank
2
# size
...
0
# e1
0.10000000000000000752E+129
# e2
0.10000000000000000540E-127
""".strip()
        assert want == got
...
0
# e1
1.0000000000000000752e+128
# e2
1.000000000000000054e-128
""").strip()
