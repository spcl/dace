...
#: Raised above the upstream paper row (I=J=256, K=160): a 256-cube horizontal stencil is ~10 M
#: points over 3 arrays, small enough on 72 threads that fork/join shows up in the median. 512
#: quadruples the plane and holds ~340 MB per array, so the pair of stencils still fits a rank.
