...
def heap_transient_sdfg(name: str) -> dace.SDFG:
...
def test_heap_allocation_aligned_new_cpp17():
    ...
    code = heap_transient_sdfg('aligned_new_probe').generate_code()[0].clean_code
...
def test_heap_allocation_plain_new_below_cpp17():
    ...
    with set_temporary('compiler', 'cpp_standard', value='14'):
        code = heap_transient_sdfg('plain_new_probe').generate_code()[0].clean_code
