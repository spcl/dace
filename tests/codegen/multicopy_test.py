...
def test_multicopy():
    ...
    # Check generated code: one copy per outgoing edge of A, no duplicates. The legacy CPU
    # target spells a copy as a dace::CopyND call, the extended one as a direct assignment
    # reading the source -- both spellings are counted as one copy site.
