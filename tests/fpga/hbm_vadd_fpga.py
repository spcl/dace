...
def create_vadd_multibank_sdfg(bank_count_per_array=2,
    ...
    in1[1].location["hbm_bank"] = subsets.Range.from_string(
        f"0:{bank_count_per_array}")
    in2[1].location["hbm_bank"] = subsets.Range.from_string(
        f"{bank_count_per_array}:{2*bank_count_per_array}")
    out[1].location["hbm_bank"] = subsets.Range.from_string(
        f"{2*bank_count_per_array}:{3*bank_count_per_array}")
