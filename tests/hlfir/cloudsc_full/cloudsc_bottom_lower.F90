...
!----------------------------------------------------------------------
  ...
  ! ===================================================
  ! BOTTOM-LOWER REPRODUCER: drop bottom-upper physics
  ! (Sed/Autoconv/Melt/Freeze/Evap, lines 2620-3355 of
  ! cloudsc.F90).  ZSOLQA/ZSOLQB/ZCOVPTOT remain at
  ! zero (their reset above); the solvers + flux +
  ! tendency run on those zeroes.  Expectation: PASS
  ! at 1e-12 since the bug is in 4.5 EVAPORATION.
  ! ===================================================
