...
SUBROUTINE CLOUDSCOUTER &
  ...
  REAL(KIND=JPRB) :: ZSOLQA_OUT(KLON,KLEV,NCLV,NCLV,NBLOCKS)
  REAL(KIND=JPRB) :: ZSOLQB_OUT(KLON,KLEV,NCLV,NCLV,NBLOCKS)
...
REAL(KIND=JPRB)   ,INTENT(OUT)   :: ZSOLQA_OUT(KLON,KLEV,NCLV,NCLV) ! captured ZSOLQA per JK
REAL(KIND=JPRB)   ,INTENT(OUT)   :: ZSOLQB_OUT(KLON,KLEV,NCLV,NCLV) ! captured ZSOLQB per JK
...
!      ZDEPOS = ZDEPOS*MIN(RDEPLIQREFRATE+ZCLDTOPDIST(JL)/RDEPLIQREFDEPTH,1.0_JPRB)
    ...
    DO JL=KIDIA,KFDIA
      ...
      IF (ZTP1(JL,JK)<RTT .AND. ZQXFG(JL,NCLDQL)>RLMIN) THEN  ! T<273K
       ...
       &             *(393.0_JPRB/(ZTP1(JL,JK)+120.0_JPRB))
        ...
        ZTERM1 = (ZVPLIQ-ZVPICE)*ZTP1(JL,JK)**2*ZVPICE*ZCORRFAC2*ZTCG* &
  ...
  ENDDO
  ! ====================================================================
  ! TOP-HALF EXTRACTION TRUNCATION POINT  -- capture ZSOLQA, ZSOLQB per JK
  ! ====================================================================
  ZSOLQA_OUT(:,JK,:,:) = ZSOLQA(:,:,:)
  ZSOLQB_OUT(:,JK,:,:) = ZSOLQB(:,:,:)
ENDDO   ! end DO JK=NCLDTOP,KLEV  (top-half-only)
END ASSOCIATE
