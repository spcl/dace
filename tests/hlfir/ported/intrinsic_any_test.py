...
@xfail('ANY(arr .eq. arr) — empty reduction source name')
...
@xfail('ANY on 2D comparison — empty reduction source')
...
@xfail('ANY on 2D subset comparison — empty reduction source')
