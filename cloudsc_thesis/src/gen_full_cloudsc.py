...
def main():
    ...
    gen_parser.add_argument('opt_level', help='The optimisation level to use')
    gen_parser.add_argument('--version', default=4, type=int, help='The CLOUDSC exp version to use')
    ...
    compile_parser.add_argument('opt_level',  help='The optimisation level to use')
    compile_parser.add_argument('--version', default=4, type=int, help='The CLOUDSC exp version to use')
    compile_parser.add_argument('--debug-build', action='store_true', default=False, help='Build in debug mode')
    ...
    change_parser.add_argument('opt_level', help='The optimisation level to use')
    change_parser.add_argument('--version', default=4, type=int, help='The CLOUDSC exp version to use')
    ...
    profile_parser.add_argument('opt_level', help='The optimisation level to use')
    profile_parser.add_argument('--version', default=4, type=int, help='The CLOUDSC exp version to use')
