# Path to the folder where cloudsc has been cloned to. THIS NEEDS TO BE ADAPTED
cloudsc_path='/users/msamuel/dwarf-p-cloudsc-dace'
# The other paths should not need any changes. They are relative to the location of this script and depend on the
# structure of the dace repository

# Path to the signature file of the DaCe generated code generated by gen_full_cloudsc.py
dace_signature_file='full_cloudsc_logs/signature_dace_cloudscexp4.txt'
# Used to generated filename of cloudsc source code
cloudsc_version=4
