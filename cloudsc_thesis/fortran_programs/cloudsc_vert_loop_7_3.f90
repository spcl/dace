!Flipped arrrays and caching & ZSOLQA is passed in and out
PROGRAM vert_loop_7_3
    ...
    REAL(KIND=JPRB) PLU(NBLOCKS, KLON, KLEV+1)
...
SUBROUTINE vert_loop_7_3_routine(&
    ...
    REAL(KIND=JPRB) PLU_NF(NBLOCKS, KLON, KLEV+1)
...
END SUBROUTINE vert_loop_7_3_routine
...
SUBROUTINE inner_loops(&
    ...
    REAL(KIND=JPRB) ZALFAW
    REAL(KIND=JPRB) RTHOMO
    REAL(KIND=JPRB) PLU_NF(KLON, KLEV+1)
