...
@dc.program
def build_up_b(rho: dc.float64, dt: dc.float64, dx: dc.float64, dy: dc.float64, u: dc.float64[ny, nx],
               v: dc.float64[ny, nx]):
    b = np.zeros_like(u)
...
@dc.program
def pressure_poisson_periodic(p: dc.float64[ny, nx], dx: dc.float64, dy: dc.float64, b: dc.float64[ny, nx]):
    pn = np.empty_like(p)
...
@dc.program
def channel_flow(nit: dc.int64, u: dc.float64[ny, nx], v: dc.float64[ny, nx], dt: dc.float64, dx: dc.float64,
                 dy: dc.float64, p: dc.float64[ny,
                                               nx], rho: dc.float64, nu: dc.float64, F: dc.float64, S: dc.float64[1]):
    udiff = 1.0
    stepcount = 0
