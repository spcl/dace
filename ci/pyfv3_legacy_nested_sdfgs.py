...
gt4py builds the wrapper to the contract, or stops building it at all: gt4py notes that the wrapper
becomes unnecessary once the specialization of array and map bounds moves upstream
