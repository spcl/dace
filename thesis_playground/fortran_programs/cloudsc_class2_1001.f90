! Copied from tests/fortran/cloudsc_3p1.f90
! And adapted to add more parameters in subroutine call to avoid error messages
PROGRAM ice_supersaturation_adjustment
    ...
    CALL ice_supersaturation_adjustment_routine( &
        ...
        & ZSOLAC, ZFOKOOP, ZPSUPSATSRCE, ZSUPSAT)
...
SUBROUTINE ice_supersaturation_adjustment_routine( &
    ...
    DO JK=NCLDTOP,KLEV
        ...
        ! Might want to remove this loop, kept it in there as it was in the original testcase and it is useful to initialise ZFOKOOP
        !DO JL=KIDIA,KFDIA
