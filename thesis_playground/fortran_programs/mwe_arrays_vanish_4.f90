PROGRAM mwe_arrays_vanish_4
    INTEGER, PARAMETER :: JPIM = SELECTED_INT_KIND(9)
    INTEGER, PARAMETER :: JPRB = SELECTED_REAL_KIND(13, 300)

    INTEGER(KIND=JPIM), PARAMETER  :: KLON = 3
    ...
    CALL mwe_arrays_vanish_4_routine(&
        & KLON, KLEV, NBLOCKS, NCLV, NCLDQI, NCLDQL, &
        & INP1, INP3, OUT1)

END PROGRAM

SUBROUTINE mwe_arrays_vanish_4_routine(&
        & KLON, KLEV, NBLOCKS, NCLV, NCLDQI, NCLDQL, &
        & INP1, INP3, OUT1)
...
END SUBROUTINE mwe_arrays_vanish_4_routine
