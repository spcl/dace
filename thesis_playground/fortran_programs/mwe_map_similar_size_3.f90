PROGRAM mwe_map_similar_size_3
    ...
    CALL mwe_map_similar_size_3_routine(&
        & KLON, KLEV, NBLOCKS, NCLV, NCLDQI, NCLDQL, &
        & INP1, INP3, OUT1)

END PROGRAM

SUBROUTINE mwe_map_similar_size_3_routine(&
        & KLON, KLEV, NBLOCKS, NCLV, NCLDQI, NCLDQL, &
        & INP1, INP3, OUT1)
...
END SUBROUTINE mwe_map_similar_size_3_routine
...
SUBROUTINE inner_loops(&
    ...
    DO JK=2,KLEV
        DO JL=1,KLON
            OUT1(JL, JK) = TMP1(JL, JK) + TMP1(JL, JK-1)
        ENDDO
    ENDDO
