PROGRAM vert_loop_3
    ...
    CALL vert_loop_3_routine(&
        & KLON, KLEV, NCLV, KIDIA, KFDIA, NCLDQS, NCLDQI, NCLDQL, NCLDTOP, NPROMA, NBLOCKS, &
        ! & PTSPHY, RLMIN, ZEPSEC, RG, ZALFAW, RTHOMO, PLU, PSNDE, PAPH, PSUPSAT, PCLV, PT, tendency_tmp_T, &
        & PLUDE)

END PROGRAM
! Base on lines 1096 to 1120 and others
SUBROUTINE vert_loop_3_routine(&
    & KLON, KLEV, NCLV, KIDIA, KFDIA, NCLDQS, NCLDQI, NCLDQL, NCLDTOP, NPROMA, NBLOCKS, &
    ! & PTSPHY, RLMIN, ZEPSEC, RG, RTHOMO, ZALFAW, PLU, PSNDE, PAPH_N, PSUPSAT_N, PCLV_N, PT_N, tendency_tmp_t_N, &
    & PLUDE)
...
END SUBROUTINE vert_loop_3_routine
