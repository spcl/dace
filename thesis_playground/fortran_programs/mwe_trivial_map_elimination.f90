PROGRAM mwe_trivial_map_elimination
    ...
    CALL mwe_trivial_map_elimination_routine(&
        & KLON, KLEV, NBLOCKS, NCLV, NCLDQL, &
        & INP1, INP3, OUT1)

END PROGRAM

SUBROUTINE mwe_trivial_map_elimination_routine(&
        & KLON, KLEV, NBLOCKS, NCLV, NCLDQL, &
        & INP1, INP3, OUT1)
...
END SUBROUTINE mwe_trivial_map_elimination_routine
